...
export const metadata = {
  ...
  description:
    "Merkato Store: the premium marketplace built for Africa and the Middle East.",
};
...
const values = [
  {
    icon: Heart,
    t: "Our mission",
    d: "Make great products accessible to everyone in the region.",
  },
  {
    icon: Globe,
    t: "Our reach",
    d: "7 countries, 6 currencies, 2 languages, one beautiful storefront.",
  },
  {
    icon: Users,
    t: "Our community",
    d: "Shoppers, makers, riders and sellers — all part of the family.",
  },
  {
    icon: Sparkles,
    t: "Our standard",
    d: "Every seller verified. Every order protected. Every promise kept.",
  },
];
    ...
    <div>
      ...
      <div className="mx-auto max-w-4xl px-4 py-12 space-y-12">
        <p className="text-lg leading-relaxed text-foreground/85">
          Online shopping in Africa and the Middle East deserves world-class
          experience. We built Merkato Store to bridge the gap between ambitious
          sellers and modern shoppers — with fast delivery, secure payments
          including mobile money, and a design language that celebrates the
          colour and craftsmanship of our region.
        </p>
        ...
        <div className="text-center">
          <h2 className="font-display text-3xl font-bold">
            Want to sell on Merkato?
          </h2>
          <p className="mt-2 text-muted-foreground">
            Reach millions of shoppers across Africa & the Middle East.
          </p>
          <Link
            href="/contact"
