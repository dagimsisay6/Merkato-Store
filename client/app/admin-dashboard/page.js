  ...
  return (
    <div>
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-3">
        {[
          { href: "/admin-dashboard/products", label: "Manage Products", desc: "Add, edit or remove products", icon: Package },
          { href: "/admin-dashboard/orders",   label: "Manage Orders",   desc: "View and update order status", icon: ShoppingBag },
          { href: "/admin-dashboard/users",    label: "Manage Users",    desc: "View users and manage roles",  icon: Users },
        ].map((c) => (
          <Link
            key={c.href}
            href={c.href}
