...
const base = [
  { name: "Aurora Wireless Noise-Cancelling Headphones", brand: "Sonix", categorySlug: "electronics", price: 129.99, originalPrice: 199.99, rating: 4.8, reviewCount: 1284, stock: 3, description: "40-hour battery, adaptive noise cancellation, plush memory-foam earcups.", features: ["Active noise cancellation", "40h battery life", "Bluetooth 5.3", "Foldable, travel case included"], tags: ["headphones", "audio", "wireless"], images: ["https://res.cloudinary.com/wfpr1ryw/image/upload/v1783707233/merkato/p-headphones.jpg"], isFeatured: true, isBestSeller: true },
  { name: "Heritage Gold Automatic Wristwatch", brand: "Marakesh", categorySlug: "accessories", price: 249.00, originalPrice: 399.00, rating: 4.7, reviewCount: 642, stock: 12, description: "A self-winding mechanical movement housed in 316L stainless steel.", features: ["Automatic movement", "50m water resistant", "Sapphire crystal", "2-year warranty"], tags: ["watch", "luxury", "accessories"], images: ["https://res.cloudinary.com/wfpr1ryw/image/upload/v1783707234/merkato/p-watch.jpg"], isFeatured: true, isBestSeller: true },
  { name: "Emerald Runner Performance Sneakers", brand: "Pace", categorySlug: "fashion", price: 89.50, originalPrice: 130.00, rating: 4.6, reviewCount: 2310, stock: 20, description: "Lightweight knit upper, responsive foam midsole.", features: ["Breathable knit upper", "Responsive cushioning", "Recycled materials", "Unisex sizing"], tags: ["sneakers", "running", "shoes"], images: ["https://res.cloudinary.com/wfpr1ryw/image/upload/v1783707235/merkato/p-sneakers.jpg"], isNewArrival: true },
  { name: "Pure Glow Vitamin C Brightening Serum", brand: "Lumière", categorySlug: "beauty", price: 34.00, originalPrice: 49.00, rating: 4.9, reviewCount: 4120, stock: 50, description: "20% pure vitamin C, hyaluronic acid and ferulic acid.", features: ["20% Vitamin C", "Dermatologist tested", "Cruelty free", "30ml glass dropper"], tags: ["serum", "skincare", "vitamin c"], images: ["https://res.cloudinary.com/wfpr1ryw/image/upload/v1783707237/merkato/p-beauty.jpg"], isNewArrival: true, isBestSeller: true },
  { name: "Royal Ankara Print Wax Fabric — 6 yards", brand: "Lagos Loom", categorySlug: "fashion", price: 59.00, originalPrice: 79.00, rating: 4.8, reviewCount: 880, stock: 8, description: "Authentic Ankara wax print, hand-finished in Lagos.", features: ["100% premium cotton", "6 yards length", "Handcrafted in Nigeria", "Fade-resistant dyes"], tags: ["fabric", "ankara", "textile"], images: ["https://res.cloudinary.com/wfpr1ryw/image/upload/v1783707238/merkato/p-fashion.jpg"], isNewArrival: true },
  { name: "Nova X12 Pro Smartphone 256GB", brand: "Nova", categorySlug: "electronics", price: 549.00, originalPrice: 699.00, rating: 4.7, reviewCount: 1860, stock: 5, description: "6.7\" AMOLED, triple 108MP camera, 5000mAh battery.", features: ["6.7\" AMOLED 120Hz", "108MP triple camera", "5000mAh + 90W charge", "Dual SIM 5G"], tags: ["smartphone", "android", "5g"], images: ["https://res.cloudinary.com/wfpr1ryw/image/upload/v1783707240/merkato/p-phones.jpg"], isFeatured: true, isBestSeller: true },
];
